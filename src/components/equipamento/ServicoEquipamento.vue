        ...
        <div class="grid-form">
            <fieldset class="form-contact-servico">
                ...
                <div class="form-group-servico">
                    ...
                    <select :class="`input-form  ${invalida[5]}`" name="backup" id="backup"
                        v-model="backup">
                        <option value=""></option>
                ...
                <div class="form-group-servico">
                    ...
                    <textarea id="observacao" name="observacao" cols="30"
